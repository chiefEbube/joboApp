    ...
    return (
        <TouchableOpacity onPress={onPress} className='flex flex-col items-start w-60 h-80 relative'>
            ...
            <View className='items-start absolute bottom-5 inset-x-5'>
                ...
                <Text className='text-base font-rubik text-white'>30 NTA Road, Port Harcourt</Text>

                <View className='flex-row items-center justify-between w-full'>
                    <Text className='text-xl font-rubik-extrabold text-white'>$2,500 <Text className='text-sm font-rubik'>per annum</Text></Text>
...
export const Card = ({onPress}: Props) => {
    return (
        <TouchableOpacity onPress={onPress} className='flex-1 w-full mt-4 px-3 py-4 rounded-lg bg-white shadow-lg shadow-black/70 relative'>
            <View className='flex-row items-center absolute px-2 top-5 right-5 bg-white/90 py-1 rounded-full z-50'>
                <Image source={icons.star} className='size-3.5'/>
                <Text className='text-xs font-rubik-bold text-primary-300 ml-0.5'>2.5</Text>
            </View>
            ...
            <View className='items-start mt-2'>
                ...
                <Text className='text-xs font-rubik text-black-200'>30 NTA Road, Port Harcourt</Text>
